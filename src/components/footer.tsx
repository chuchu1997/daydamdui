    ...
    <footer className="bg-gradient-to-b from-[#333333] to-gray-900 text-gray-200 py-12 shadow-lg">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <h2 className="mb-4 uppercase text-lg md:text-xl lg:text-2xl font-bold text-white relative inline-block after:content-[''] after:absolute after:w-1/2 after:h-1 after:bg-white after:left-1/4 after:-bottom-3">
                Giới Thiệu
              </h2>
          ...
          <div className="space-y-6">
            <h2 className="uppercase mb-4 text-lg md:text-xl lg:text-xl font-bold text-white relative inline-block after:content-[''] after:absolute after:w-1/2 after:h-1 after:bg-white after:left-1/4 after:-bottom-3">
          ...
          {/* Contact Info Column */}
          <div className="space-y-6">
            <h2 className="mb-4 uppercase text-lg md:text-xl lg:text-xl font-bold text-white relative inline-block after:content-[''] after:absolute after:w-1/2 after:h-1 after:bg-white after:left-1/4 after:-bottom-3">
              Liên Hệ
            </h2>
            <ul className="space-y-4 mt-5 text-sm md:text-base lg:text-md">
        ...
        <div className="flex justify-center space-x-4 mt-10">
          <a href="https://www.facebook.com/daydamdui" className="bg-gray-700 p-2 rounded-full text-white hover:bg-accent hover:text-white transition-all duration-300">
